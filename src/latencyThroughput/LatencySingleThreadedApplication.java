...
public class LatencySingleThreadedApplication {
    ...
    public static void recolorSingleThreaded(BufferedImage ogImage, BufferedImage rgImage) {
        recolorImage(ogImage, rgImage, 0, 0, ogImage.getHeight(), ogImage.getWidth());
    }
